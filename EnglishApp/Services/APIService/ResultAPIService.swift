...
protocol ResultAPIServiceProtocol {
    ...
    func getResultTeam(idCompetition: Int, offset: Int, success: @escaping SuccessHandler<ResultTeamCompetitionRespone>.object,failure: @escaping RequestFailure)
...
class ResultAPIService: ResultAPIServiceProtocol {
    ...
    func getResultTeam(idCompetition: Int, offset: Int,success: @escaping SuccessHandler<ResultTeamCompetitionRespone>.object,failure: @escaping RequestFailure){
        let endpoint = ResultEndpoint.getResultTeam(id: idCompetition, offset: offset)
        network.requestData(endPoint: endpoint, success: MapperData.mapObject(success), failure: failure)
    }
