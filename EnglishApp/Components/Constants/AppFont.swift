...
struct AppFont {
    static let fontRegular18 = UIFont(name: "Comfortaa-Regular", size: 18)!
    ...
    static let fontBold16 = UIFont(name: "Comfortaa-Bold", size: 16)!
    static let fontBold18 = UIFont(name: "Comfortaa-Bold", size: 18)!
