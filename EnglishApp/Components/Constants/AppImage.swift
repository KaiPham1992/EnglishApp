...
struct AppImage {
    ...
    static let imgStore = UIImage(named: "ic_member")!
    ...
    static let imgPrivacy = UIImage(named: "ic_shield")!.withRenderingMode(.alwaysTemplate)
    ...
    static let imgPremium = UIImage(named: "king")!
